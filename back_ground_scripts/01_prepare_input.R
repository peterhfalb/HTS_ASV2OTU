# 01_prepare_input.R
# Prepares a single combined FASTA and abundance table from a concatenated ASV+taxonomy table
# Usage: Rscript 01_prepare_input.R <asv_table_path> <working_dir>
...
if (length(args) < 2) {
  stop("Usage: Rscript 01_prepare_input.R <asv_table_path> <working_dir>")
}
...
# This is used later by 03_build_otu_table.R to reconstruct OTU abundances
# ------------------------------------------------------------------------------
