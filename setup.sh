...
echo "  ITS1    - fungal ITS1 region (UNITE database, ITSx disabled by default)"
echo "  ITS2    - fungal ITS2 region (UNITE database, ITSx disabled by default)"
echo "  16S-V4  - bacterial 16S V4 region (SILVA database, no ITSx)"
echo "  18S-V4  - microeukaryote 18S V4 region (PR2 database, no ITSx)"
echo "  18S-AMF - arbuscular mycorrhizal fungi 18S (MaarjAM database)"
echo ""
echo "  OPTIONS:"
...
echo "  Maarjam      - AMF 18S SSU sequences (arbuscular mycorrhizal fungi)"
echo "  EukaryomeITS - ITS1 and ITS2 sequences with good coverage across the eukaryote tree"
echo "  EukaryomeSSU - 18S SSU sequences with good coverage across the eukaryote tree"
echo ""
echo "  Examples:"
echo "  run_asv2otu /path/to/project /path/to/ASVtable.tsv FAB2 ITS2"
echo "  run_asv2otu /path/to/project /path/to/ASVtable.tsv FAB2 ITS2 --run-itsx"
